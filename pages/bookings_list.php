...
<head>
  ...
  <link rel="stylesheet" href="/assessment_beginner/assets/style.css?v=2">
</head>
<body>
<?php include "../nav.php"; ?>
    ...
    <tr>
      ...
      <td>
        <?php
          ...
          $cls = "status";
          if ($st === "PENDING") $cls .= " status-pending";
          else if ($st === "PARTIAL") $cls .= " status-partial";
          else if ($st === "PAID") $cls .= " status-paid";
        ?>
        <span class="<?php echo $cls; ?>"><?php echo $b['status']; ?></span>
      </td>
      <td>
